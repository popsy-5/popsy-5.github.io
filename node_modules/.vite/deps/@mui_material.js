...
var FormControlLabel = React44.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime51.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React44.cloneElement(control, controlProps), required ? (0, import_jsx_runtime51.jsxs)(Stack_default, {
      display: "block",
...
true ? NoSsr.propTypes = {
   ...
   * @default false
   */
  defer: import_prop_types73.default.bool,
  /**
   * The fallback content to display.
   * @default null
   */
  fallback: import_prop_types73.default.node
} : void 0;
if (true) {
...
var Snackbar = React97.forwardRef(function Snackbar2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded75), other = _objectWithoutPropertiesLoose(props, _excluded216);
  const ownerState = _extends({}, props, {
    anchorOrigin: {
      vertical,
      horizontal
...
var Step = React100.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime113.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime112.jsxs)(React100.Fragment, {
...
var StepButton = React105.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React105.cloneElement(children, childProps) : (0, import_jsx_runtime120.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var Tab = React112.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime129.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime129.jsxs)(React112.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime129.jsxs)(React112.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
